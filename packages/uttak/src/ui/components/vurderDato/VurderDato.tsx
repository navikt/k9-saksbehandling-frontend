    ...
    return (
        <div className={styles.vurderDatoContainer}>
            <Alert variant="warning" size="small" className="mt-4">
                ...
                <BodyLong size="small">
                    Det er lansert endringer for hvordan utbetalingsgrad settes for nye aktiviteter, ikke yrkesaktiv og
                    kun ytelse. Vurder hvilken dato endringene skal gjelde fra i denne saken. Dager før denne datoen vil
                    følge gammel praksis.
                </BodyLong>
            </Alert>
                    ...
                    <Accordion.Item>
                        ...
                        <Accordion.Content>
                            <BodyLong size="small">
                                ...
                                <ol>
                                    <li>
                                        Nye aktiviteter blir tatt med ved utregning av utbetalingsgrad og søkers
                                        uttaksgrad.
                                    </li>
